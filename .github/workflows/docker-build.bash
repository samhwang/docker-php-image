...
docker build -f Dockerfile-apache-alpine -t ${DOCKER_USERNAME}/php:7.3 .
docker build -f Dockerfile-apache-debian -t ${DOCKER_USERNAME}/php:7.3-nginx .
docker build -f Dockerfile-nginx-alpine -t ${DOCKER_USERNAME}/php:7.3-apache-alpine .
docker build -f Dockerfile-nginx-debian -t ${DOCKER_USERNAME}/php:7.3-nginx-alpine .
